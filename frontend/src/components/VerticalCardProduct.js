  ...
  return (
    <div className="container mx-auto px-4 my-6 relative">
      ...
      <div className="relative">
        ...
        <div
          className="flex items-center gap-4 md:gap-6 overflow-x-scroll scrollbar-none transition-all p-3"
          ref={scrollElement}
        >
          {loading
            ...
            : data.map((product, index) => (
                <Link
                  ...
                  className="w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] bg-white rounded-xl shadow-lg shadow-gray-500"
                >
                  ...
                  <div className="p-4 grid gap-3">
                    ...
                    <div className="flex gap-3">
                      <p className="text-Orange font-medium">
                        {displayGHSCurrency(product?.sellingPrice)}
                      </p>
                    ...
                    <button
                      className="text-sm bg-Orange hover:bg-Orange text-white px-3 py-2 rounded-full"
