    ...
    return (
        <div className='container mx-auto px-4 my-5 relative '>
            ...
            <div className='flex items-center gap-4 md:gap-6 overflow-hidden '>
                <button
                    className='bg-Orange text-white shadow-md rounded-full p-2 absolute left-0 text-lg z-20 hidden md:block'
                    onClick={scrollLeft}
                >
                    <FaAngleLeft />
                </button>
                <button
                    className='bg-Orange text-white shadow-md rounded-full p-2 absolute right-0 text-lg z-20 hidden md:block'
                    onClick={scrollRight}
                >
                    <FaAngleRight />
                </button>
